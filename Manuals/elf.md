В этом гайде я расскажу о том, как написать минимальный исполняемый файл на Linux. Я использовал формат ELF (Executable and Linkable Format). 
# Начало файла
...
Поясню подробнее каждое поле структуры.
...
Я разобрался, как создавать самому ELF-файл, как настроить его заголовок под себя, как разместить исполняемый код. Как видим, создать исполняемый файл в Linux совсем не сложно.

# Ссылки

https://docs.oracle.com/cd/E23824_01/html/819-0690/chapter6-46512.html#scrolltoc - оракловские доки по ELF-ам